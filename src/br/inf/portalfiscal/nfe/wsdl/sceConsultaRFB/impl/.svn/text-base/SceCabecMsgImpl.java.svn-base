 ...
 */
public class SceCabecMsgImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements br.inf.portalfiscal.nfe.wsdl.sceConsultaRFB.SceCabecMsg
{
    ...
    private static final javax.xml.namespace.QName VERSAODADOS$0 = 
        new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/nfe/wsdl/SCEConsultaRFB", "versaoDados");
