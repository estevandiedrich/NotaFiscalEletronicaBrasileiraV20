...
public class XMLGerados {
	private XMLGerados()
	{
		
	}
	private static final Logger logger = Logger.getLogger("XMLGerados");
	private static XMLGerados me = null;
	...
	public synchronized static XMLGerados getInstance()
	{
		if(me == null)
		{
