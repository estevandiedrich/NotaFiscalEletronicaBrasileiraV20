...
public class DpecDescompactados {
	private static final Logger logger = Logger.getLogger("DpecDescompactados");
	private static DpecDescompactados me = null;
	...
	public synchronized static DpecDescompactados getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new DpecDescompactados();
		}
		return me;
	}
}
