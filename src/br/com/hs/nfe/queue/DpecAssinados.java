...
public class DpecAssinados {
	private static final Logger logger = Logger.getLogger("DpecAssinados");
	private static DpecAssinados me = null;
	...
	public synchronized static DpecAssinados getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new DpecAssinados();
		}
		return me;
	}
}
