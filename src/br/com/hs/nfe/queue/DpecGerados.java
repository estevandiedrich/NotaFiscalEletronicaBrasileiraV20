...
public class DpecGerados {
	private static final Logger logger = Logger.getLogger("DpecGerados");
	private static DpecGerados me = null;
	...
	public synchronized static DpecGerados getInstance()
	{
		if(me == null)
		{
