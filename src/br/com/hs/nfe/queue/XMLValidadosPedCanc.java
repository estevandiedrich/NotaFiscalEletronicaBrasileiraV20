...
public class XMLValidadosPedCanc {
	public XMLValidadosPedCanc()
	{
		
	}
	private static final Logger logger = Logger.getLogger("XMLValidadosPedCanc");
	private static XMLValidadosPedCanc me = null;
	...
	public synchronized static XMLValidadosPedCanc getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new XMLValidadosPedCanc();
		}
		return me;
	}
}
