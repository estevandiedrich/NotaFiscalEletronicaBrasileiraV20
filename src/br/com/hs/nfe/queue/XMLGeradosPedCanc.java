...
public class XMLGeradosPedCanc {
	private XMLGeradosPedCanc()
	{
		
	}
	private static final Logger logger = Logger.getLogger("XMLGeradosPedCanc");
	private static XMLGeradosPedCanc me = null;
	...
	public synchronized static XMLGeradosPedCanc getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new XMLGeradosPedCanc();
		}
		return me;
	}
}
