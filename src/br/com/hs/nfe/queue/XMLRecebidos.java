...
public class XMLRecebidos {
	private XMLRecebidos()
	{
		
	}
	private static final Logger logger = Logger.getLogger("XMLRecebidos");
	private static XMLRecebidos me = null;
	...
	public synchronized static XMLRecebidos getInstance()
	{
		if(me == null)
		{
