...
public class DpecValidados {
	private static final Logger logger = Logger.getLogger("DpecValidados");
	private static DpecValidados me = null;
	...
	public synchronized static DpecValidados getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new DpecValidados();
		}
		return me;
	}
}
