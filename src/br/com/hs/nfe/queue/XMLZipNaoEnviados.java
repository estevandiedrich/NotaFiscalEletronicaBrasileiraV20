...
public class XMLZipNaoEnviados {
	private static final Logger logger = Logger.getLogger("XMLZipNaoEnviados");
	private static XMLZipNaoEnviados me = null;
	...
	public synchronized static XMLZipNaoEnviados getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista XMLZipNaoEnviados");
			me = new XMLZipNaoEnviados();
		}
		return me;
	}
}
