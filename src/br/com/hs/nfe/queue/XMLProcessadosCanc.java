...
public class XMLProcessadosCanc {
	private XMLProcessadosCanc()
	{
		
	}
	private static final Logger logger = Logger.getLogger("XMLProcessadosCanc");
	private static XMLProcessadosCanc me = null;
	...
	public synchronized static XMLProcessadosCanc getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new XMLProcessadosCanc();
		}
		return me;
	}
}
