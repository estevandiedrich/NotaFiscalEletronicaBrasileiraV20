...
public class XMLAutorizados {
	private XMLAutorizados()
	{
		
	}
	private static final Logger logger = Logger.getLogger("XMLAutorizados");
	private static XMLAutorizados me = null;
	...
	public synchronized static XMLAutorizados getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new XMLAutorizados();
		}
		return me;
	}
}
