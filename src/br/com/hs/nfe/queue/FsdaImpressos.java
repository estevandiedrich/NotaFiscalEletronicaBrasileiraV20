...
public class FsdaImpressos {
	private static final Logger logger = Logger.getLogger("FsdaImpressos");
	private static FsdaImpressos me = null;
	...
	public synchronized static FsdaImpressos getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new FsdaImpressos();
		}
		return me;
	}
}
