...
public class XMLProcessados {
	private XMLProcessados()
	{
		
	}
	private static final Logger logger = Logger.getLogger("XMLProcessados");
	private static XMLProcessados me = null;
	...
	public synchronized static XMLProcessados getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new XMLProcessados();
		}
		return me;
	}
}
