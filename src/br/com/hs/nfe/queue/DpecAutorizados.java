...
public class DpecAutorizados {
	private static final Logger logger = Logger.getLogger("DpecAutorizados");
	private static DpecAutorizados me = null;
	...
	public synchronized static DpecAutorizados getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new DpecAutorizados();
		}
		return me;
	}
}
