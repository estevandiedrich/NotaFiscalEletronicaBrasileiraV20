...
public class FsdaPreparados {
	private static final Logger logger = Logger.getLogger("FsdaPreparados");
	private static FsdaPreparados me = null;
	...
	public synchronized static FsdaPreparados getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new FsdaPreparados();
		}
		return me;
	}
}
