...
public class XMLDescompactadosCanc {
	public XMLDescompactadosCanc()
	{
		
	}
	private static final Logger logger = Logger.getLogger("XMLDescompactadosCanc");
	private static XMLDescompactadosCanc me = null;
	...
	public synchronized static XMLDescompactadosCanc getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new XMLDescompactadosCanc();
		}
		return me;
	}
}
