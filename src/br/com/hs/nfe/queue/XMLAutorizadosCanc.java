...
public class XMLAutorizadosCanc {
	private XMLAutorizadosCanc()
	{
		
	}
	private static final Logger logger = Logger.getLogger("XMLAutorizadosCanc");
	private static XMLAutorizadosCanc me = null;
	...
	public synchronized static XMLAutorizadosCanc getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new XMLAutorizadosCanc();
		}
		return me;
	}
}
