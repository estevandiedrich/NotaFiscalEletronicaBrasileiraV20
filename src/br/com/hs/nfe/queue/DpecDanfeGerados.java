...
public class DpecDanfeGerados {
	private static final Logger logger = Logger.getLogger("DpecDanfeGerados");
	private static DpecDanfeGerados me = null;
	...
	public synchronized static DpecDanfeGerados getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new DpecDanfeGerados();
		}
		return me;
	}
}
