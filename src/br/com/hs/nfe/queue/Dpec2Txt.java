...
public class Dpec2Txt {
	private static final Logger logger = Logger.getLogger("Dpec2Txt");
	private static Dpec2Txt me = null;
	...
	public synchronized static Dpec2Txt getInstance()
	{
		if(me == null)
		{
