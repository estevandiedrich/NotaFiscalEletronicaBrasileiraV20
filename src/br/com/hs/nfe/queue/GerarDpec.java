...
public class GerarDpec {
	private static final Logger logger = Logger.getLogger("GerarDpec");
	private static GerarDpec me = null;
	...
	public synchronized static GerarDpec getInstance()
	{
		if(me == null)
		{
