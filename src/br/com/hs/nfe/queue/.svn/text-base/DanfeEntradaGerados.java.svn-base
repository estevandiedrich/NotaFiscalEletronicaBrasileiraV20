...
public class DanfeEntradaGerados {
	private static final Logger logger = Logger.getLogger("DanfeEntradaGerados");
	private static DanfeEntradaGerados me = null;
	...
	public synchronized static DanfeEntradaGerados getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new DanfeEntradaGerados();
		}
		return me;
	}
}
