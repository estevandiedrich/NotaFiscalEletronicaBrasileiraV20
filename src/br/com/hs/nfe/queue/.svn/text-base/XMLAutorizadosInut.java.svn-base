...
public class XMLAutorizadosInut {
	private XMLAutorizadosInut()
	{
		
	}
	private static final Logger logger = Logger.getLogger("XMLAutorizadosInut");
	private static XMLAutorizadosInut me = null;
	...
	public synchronized static XMLAutorizadosInut getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new XMLAutorizadosInut();
		}
		return me;
	}
}
