...
public class XMLCanc2Txt {
	private XMLCanc2Txt()
	{
		
	}
	private static final Logger logger = Logger.getLogger("XMLCanc2Txt");
	private static XMLCanc2Txt me = null;
	...
	public synchronized static XMLCanc2Txt getInstance()
	{
		if(me == null)
		{
