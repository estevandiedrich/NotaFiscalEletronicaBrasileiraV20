...
public class DpecZipNaoEnviados {
	private static final Logger logger = Logger.getLogger("DpecZipNaoEnviados");
	private static DpecZipNaoEnviados me = null;
	...
	public synchronized static DpecZipNaoEnviados getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new DpecZipNaoEnviados();
		}
		return me;
	}
}
