...
public class CTeValidos {
	private static final Logger logger = Logger.getLogger("CTeValidos");
	private static CTeValidos me = null;
	...
	public synchronized static CTeValidos getInstance()
	{
		if(me == null)
		{
