...
public class XMLEnviadosPedCanc {
	private XMLEnviadosPedCanc()
	{
		
	}
	private static final Logger logger = Logger.getLogger("XMLAssinados");
	private static XMLEnviadosPedCanc me = null;
	...
	public synchronized static XMLEnviadosPedCanc getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new XMLEnviadosPedCanc();
		}
		return me;
	}
}
