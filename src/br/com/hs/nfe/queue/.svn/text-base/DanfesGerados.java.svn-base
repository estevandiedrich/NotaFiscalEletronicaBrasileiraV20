...
public class DanfesGerados {
	private DanfesGerados()
	{
		
	}
	private static final Logger logger = Logger.getLogger("DanfesGerados");
	private static DanfesGerados me = null;
	...
	public synchronized static DanfesGerados getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new DanfesGerados();
		}
		return me;
	}
}
