...
public class XMLEntradaValido {
	private static final Logger logger = Logger.getLogger("XMLEntradaValido");
	private static XMLEntradaValido me = null;
	...
	public synchronized static XMLEntradaValido getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new XMLEntradaValido();
		}
		return me;
	}
}
