...
public class TxtRetornoNFeEntradaGerado {
	private TxtRetornoNFeEntradaGerado()
	{
		
	}
	private static final Logger logger = Logger.getLogger("TxtRetornoNFeEntradaGerado");
	private static TxtRetornoNFeEntradaGerado me = null;
	...
	public synchronized static TxtRetornoNFeEntradaGerado getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new TxtRetornoNFeEntradaGerado();
		}
		return me;
	}
}
