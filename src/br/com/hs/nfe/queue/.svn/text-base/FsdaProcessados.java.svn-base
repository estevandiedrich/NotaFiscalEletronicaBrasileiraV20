...
public class FsdaProcessados {
	private static final Logger logger = Logger.getLogger("FsdaProcessados");
	private static FsdaProcessados me = null;
	...
	public synchronized static FsdaProcessados getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new FsdaProcessados();
		}
		return me;
	}
}
