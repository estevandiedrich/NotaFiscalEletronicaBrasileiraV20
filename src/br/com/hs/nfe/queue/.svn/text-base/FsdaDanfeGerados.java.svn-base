...
public class FsdaDanfeGerados {
	private static final Logger logger = Logger.getLogger("FsdaDanfeGerados");
	private static FsdaDanfeGerados me = null;
	...
	public synchronized static FsdaDanfeGerados getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new FsdaDanfeGerados();
		}
		return me;
	}
}
