...
public class XMLValidadosPedInut {
	public XMLValidadosPedInut()
	{
		
	}
	private static final Logger logger = Logger.getLogger("XMLValidadosPedInut");
	private static XMLValidadosPedInut me = null;
	...
	public synchronized static XMLValidadosPedInut getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista XMLValidadosPedInut");
			me = new XMLValidadosPedInut();
		}
		return me;
	}
}
