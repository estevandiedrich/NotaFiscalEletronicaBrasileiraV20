...
public class XMLEntradaProcessados {
	private static final Logger logger = Logger.getLogger("XMLEntradaProcessados");
	private static XMLEntradaProcessados me = null;
	...
	public synchronized static XMLEntradaProcessados getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new XMLEntradaProcessados();
		}
		return me;
	}
}
