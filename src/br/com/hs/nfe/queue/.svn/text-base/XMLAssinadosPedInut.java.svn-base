...
public class XMLAssinadosPedInut {
	public XMLAssinadosPedInut()
	{
		
	}
	private static final Logger logger = Logger.getLogger("XMLAssinadosPedInut");
	private static XMLAssinadosPedInut me = null;
	...
	public synchronized static XMLAssinadosPedInut getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new XMLAssinadosPedInut();
		}
		return me;
	}
}
