...
public class DpecProcessados {
	private static final Logger logger = Logger.getLogger("DpecProcessados");
	private static DpecProcessados me = null;
	...
	public synchronized static DpecProcessados getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new DpecProcessados();
		}
		return me;
	}
}
