...
public class EmailsEnviados {
	private EmailsEnviados()
	{
		
	}
	private static final Logger logger = Logger.getLogger("EmailsEnviados");
	private static EmailsEnviados me = null;
	...
	public synchronized static EmailsEnviados getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new EmailsEnviados();
		}
		return me;
	}
}
