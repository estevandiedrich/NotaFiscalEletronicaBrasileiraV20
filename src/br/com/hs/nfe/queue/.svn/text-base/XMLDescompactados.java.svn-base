...
public class XMLDescompactados {
	public XMLDescompactados()
	{
		
	}
	private static final Logger logger = Logger.getLogger("XMLDescompactados");
	private static XMLDescompactados me = null;
	...
	public synchronized static XMLDescompactados getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new XMLDescompactados();
		}
		return me;
	}
}
