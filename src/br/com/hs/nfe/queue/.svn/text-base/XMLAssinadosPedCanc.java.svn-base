...
public class XMLAssinadosPedCanc {
	public XMLAssinadosPedCanc()
	{
		
	}
	private static final Logger logger = Logger.getLogger("XMLAssinadosPedCanc");
	private static XMLAssinadosPedCanc me = null;
	...
	public synchronized static XMLAssinadosPedCanc getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new XMLAssinadosPedCanc();
		}
		return me;
	}
}
