...
public class DpecEmailsEnviados {
	private static final Logger logger = Logger.getLogger("DpecEmailsEnviados");
	private static DpecEmailsEnviados me = null;
	...
	public synchronized static DpecEmailsEnviados getInstance()
	{
		if(me == null)
		{
			logger.info("Inicializando a lista");
			me = new DpecEmailsEnviados();
		}
		return me;
	}
}
