...
public class XMLEnviados {
	private XMLEnviados()
	{
		
	}
	private static final Logger logger = Logger.getLogger("XMLEnviados");
	private static XMLEnviados me = null;
	...
	public synchronized static XMLEnviados getInstance()
	{
		if(me == null)
		{
