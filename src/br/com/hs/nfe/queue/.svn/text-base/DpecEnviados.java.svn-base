...
public class DpecEnviados {
	private static final Logger logger = Logger.getLogger("DpecEnviados");
	private static DpecEnviados me = null;
	...
	public synchronized static DpecEnviados getInstance()
	{
		if(me == null)
		{
