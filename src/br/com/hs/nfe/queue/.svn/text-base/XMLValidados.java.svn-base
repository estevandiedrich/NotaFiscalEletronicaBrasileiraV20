...
public class XMLValidados {
	private XMLValidados()
	{
		
	}
	private static final Logger logger = Logger.getLogger("XMLValidados");
	private static XMLValidados me = null;
	...
	public synchronized static XMLValidados getInstance()
	{
		if(me == null)
		{
