...
@WebServiceClient(name = "NfeStatusServico2", 
                  wsdlLocation = "file:NfeStatusServico2.wsdl",
                  targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2") 
public class NfeStatusServico2 extends Service {

    public final static URL WSDL_LOCATION = Thread.currentThread().getContextClassLoader().getResource("wsdl/br/homo/NfeStatusServico2.wsdl");
