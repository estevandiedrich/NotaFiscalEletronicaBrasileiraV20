...
@WebServiceClient(name = "NfeRecepcao2", 
                  wsdlLocation = "file:NfeRecepcao2.wsdl",
                  targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NfeRecepcao2") 
public class NfeRecepcao2 extends Service {

    public final static URL WSDL_LOCATION  = Thread.currentThread().getContextClassLoader().getResource("wsdl/br/homo/NfeRecepcao2.wsdl");
