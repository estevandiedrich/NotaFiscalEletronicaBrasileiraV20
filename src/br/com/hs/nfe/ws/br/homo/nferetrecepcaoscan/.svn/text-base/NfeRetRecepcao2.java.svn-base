...
@WebServiceClient(name = "NfeRetRecepcao2", 
                  wsdlLocation = "file:NfeRetRecepcao2.wsdl",
                  targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NfeRetRecepcao2") 
public class NfeRetRecepcao2 extends Service {

    public final static URL WSDL_LOCATION  = Thread.currentThread().getContextClassLoader().getResource("wsdl/br/homo/NfeRetRecepcao2.wsdl");
