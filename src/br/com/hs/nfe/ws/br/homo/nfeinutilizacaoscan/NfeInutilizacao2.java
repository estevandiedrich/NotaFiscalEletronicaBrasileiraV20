...
@WebServiceClient(name = "NfeInutilizacao2", 
                  wsdlLocation = "file:NfeInutilizacao2.wsdl",
...
public class NfeInutilizacao2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NfeInutilizacao2.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NfeInutilizacao2.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
