...
package br.com.hs.nfe.ws.ms.homo.nferetrecepcao2;
...
@WebServiceClient(name = "NfeRetRecepcao2", 
                  wsdlLocation = "file:NfeRetRecepcao2MSHomo.xml",
...
public class NfeRetRecepcao2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NfeRetRecepcao2MSHomo.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NfeRetRecepcao2MSHomo.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
