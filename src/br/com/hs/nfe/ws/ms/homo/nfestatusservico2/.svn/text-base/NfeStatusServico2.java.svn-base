...
package br.com.hs.nfe.ws.ms.homo.nfestatusservico2;
...
@WebServiceClient(name = "NfeStatusServico2", 
                  wsdlLocation = "file:NfeStatusServico2MSHomo.xml",
...
public class NfeStatusServico2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NfeStatusServico2MSHomo.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NfeStatusServico2MSHomo.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
