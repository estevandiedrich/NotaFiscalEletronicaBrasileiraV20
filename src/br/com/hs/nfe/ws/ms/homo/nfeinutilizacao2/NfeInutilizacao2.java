...
package br.com.hs.nfe.ws.ms.homo.nfeinutilizacao2;
...
@WebServiceClient(name = "NfeInutilizacao2", 
                  wsdlLocation = "file:NfeInutilizacao2MSHomo.xml",
...
public class NfeInutilizacao2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NfeInutilizacao2MSHomo.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NfeInutilizacao2MSHomo.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
