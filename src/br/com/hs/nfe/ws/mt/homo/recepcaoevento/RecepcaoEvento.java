...
package br.com.hs.nfe.ws.mt.homo.recepcaoevento;
...
@WebServiceClient(name = "RecepcaoEvento", 
                  wsdlLocation = "file:RecepcaoEventoMTHomo.xml",
...
public class RecepcaoEvento extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:RecepcaoEventoMTHomo.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:RecepcaoEventoMTHomo.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
