...
@WebServiceClient(name = "NfeInutilizacao2", 
                  wsdlLocation = "file:NfeInutilizacao2MTHomo.xml",
...
public class NfeInutilizacao2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NfeInutilizacao2MTHomo.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NfeInutilizacao2MTHomo.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
