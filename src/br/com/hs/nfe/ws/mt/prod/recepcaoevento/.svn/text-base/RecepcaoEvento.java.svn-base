...
package br.com.hs.nfe.ws.mt.prod.recepcaoevento;
...
@WebServiceClient(name = "RecepcaoEvento", 
                  wsdlLocation = "file:RecepcaoEventoMTProd.xml",
...
public class RecepcaoEvento extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:RecepcaoEventoMTProd.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:RecepcaoEventoMTProd.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
