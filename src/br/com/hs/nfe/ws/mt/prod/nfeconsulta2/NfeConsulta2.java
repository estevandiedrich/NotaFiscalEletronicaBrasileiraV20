...
package br.com.hs.nfe.ws.mt.prod.nfeconsulta2;
...
@WebServiceClient(name = "NfeConsulta2", 
                  wsdlLocation = "file:NfeConsulta2MTProd.xml",
...
public class NfeConsulta2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NfeConsulta2MTProd.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NfeConsulta2MTProd.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
