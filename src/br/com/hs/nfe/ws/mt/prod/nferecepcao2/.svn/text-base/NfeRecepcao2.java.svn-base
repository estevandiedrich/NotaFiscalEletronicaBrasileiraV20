...
@WebServiceClient(name = "NfeRecepcao2", 
                  wsdlLocation = "file:NfeRecepcao2MTProd.xml",
...
public class NfeRecepcao2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NfeRecepcao2MTProd.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NfeRecepcao2MTProd.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
