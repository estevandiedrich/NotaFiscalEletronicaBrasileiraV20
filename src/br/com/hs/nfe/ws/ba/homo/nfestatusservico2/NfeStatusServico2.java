...
@WebServiceClient(name = "NfeStatusServico2", 
                  wsdlLocation = "file:NfeStatusServico2BAHomo.xml",
...
public class NfeStatusServico2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NfeStatusServico2BAHomo.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NfeStatusServico2BAHomo.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
