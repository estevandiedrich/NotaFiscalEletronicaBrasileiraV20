...
package br.com.hs.nfe.ws.ba.homo.nferetrecepcao2;
...
@WebServiceClient(name = "NfeRetRecepcao2", 
                  wsdlLocation = "file:NfeRetRecepcao2BAHomo.xml",
...
public class NfeRetRecepcao2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NfeRetRecepcao2BAHomo.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NfeRetRecepcao2BAHomo.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
