...
package br.com.hs.nfe.ws.ba.homo.nfeinutilizacao2;
...
@WebServiceClient(name = "NfeInutilizacao2", 
                  wsdlLocation = "file:NfeInutilizacao2BAHomo.xml",
...
public class NfeInutilizacao2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NfeInutilizacao2BAHomo.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NfeInutilizacao2BAHomo.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
