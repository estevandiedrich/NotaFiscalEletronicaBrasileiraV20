...
@WebServiceClient(name = "RecepcaoEvento", 
                  wsdlLocation = "file:RecepcaoEventoSPHomo.xml",
...
public class RecepcaoEvento extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:RecepcaoEventoSPHomo.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:RecepcaoEventoSPHomo.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
