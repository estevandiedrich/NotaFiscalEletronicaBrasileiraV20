...
@WebServiceClient(name = "NfeCancelamento2", 
                  wsdlLocation = "file:NfeCancelamento2SPHomo.xml",
...
public class NfeCancelamento2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NfeCancelamento2SPHomo.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NfeCancelamento2SPHomo.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
