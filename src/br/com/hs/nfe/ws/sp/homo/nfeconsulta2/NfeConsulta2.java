...
package br.com.hs.nfe.ws.sp.homo.nfeconsulta2;
...
@WebServiceClient(name = "NfeConsulta2", 
                  wsdlLocation = "file:NfeConsulta2SPHomo.xml",
...
public class NfeConsulta2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NfeConsulta2SPHomo.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NfeConsulta2SPHomo.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
