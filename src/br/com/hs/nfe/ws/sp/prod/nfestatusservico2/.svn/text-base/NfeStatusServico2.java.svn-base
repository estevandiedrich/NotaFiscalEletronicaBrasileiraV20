...
package br.com.hs.nfe.ws.sp.prod.nfestatusservico2;
...
@WebServiceClient(name = "NfeStatusServico2", 
                  wsdlLocation = "file:nfestatusservico2SPProd.xml",
...
public class NfeStatusServico2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:nfestatusservico2SPProd.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:nfestatusservico2SPProd.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
