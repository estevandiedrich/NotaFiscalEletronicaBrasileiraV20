...
@WebServiceClient(name = "NfeRecepcao2", 
                  wsdlLocation = "file:nferecepcao2SPProd.xml",
...
public class NfeRecepcao2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:nferecepcao2SPProd.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:nferecepcao2SPProd.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
