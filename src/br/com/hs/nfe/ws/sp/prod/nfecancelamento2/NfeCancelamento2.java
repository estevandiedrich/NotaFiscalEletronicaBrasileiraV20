...
@WebServiceClient(name = "NfeCancelamento2", 
                  wsdlLocation = "file:nfecancelamento2SPProd.xml",
...
public class NfeCancelamento2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:nfecancelamento2SPProd.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:nfecancelamento2SPProd.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
