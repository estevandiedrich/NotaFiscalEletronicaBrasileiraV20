...
package br.com.hs.nfe.ws.sp.prod.recepcaoevento;
...
@WebServiceClient(name = "RecepcaoEvento", 
                  wsdlLocation = "file:RecepcaoEventoSPProd.xml",
...
public class RecepcaoEvento extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:RecepcaoEventoSPProd.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:RecepcaoEventoSPProd.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
