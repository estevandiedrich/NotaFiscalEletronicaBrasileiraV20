...
@WebServiceClient(name = "NfeInutilizacao2", 
                  wsdlLocation = "file:nfeinutilizacao2SPProd.xml",
...
public class NfeInutilizacao2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:nfeinutilizacao2SPProd.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:nfeinutilizacao2SPProd.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
