...
@WebServiceClient(name = "NfeRetRecepcao2", 
                  wsdlLocation = "file:nferetrecepcao2SPProd.xml",
...
public class NfeRetRecepcao2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:nferetrecepcao2SPProd.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:nferetrecepcao2SPProd.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
