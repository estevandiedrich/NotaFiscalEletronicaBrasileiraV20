...
@WebServiceClient(name = "NfeRecepcao2", 
                  wsdlLocation = "file:NFeRecepcao2PRHomo.xml",
...
public class NfeRecepcao2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NFeRecepcao2PRHomo.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NFeRecepcao2PRHomo.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
