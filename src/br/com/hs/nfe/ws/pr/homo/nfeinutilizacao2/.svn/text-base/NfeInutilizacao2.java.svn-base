...
@WebServiceClient(name = "NfeInutilizacao2", 
                  wsdlLocation = "file:NFeInutilizacao2PRHomo.xml",
...
public class NfeInutilizacao2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NFeInutilizacao2PRHomo.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NFeInutilizacao2PRHomo.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
