...
@WebServiceClient(name = "NfeCancelamento2", 
                  wsdlLocation = "file:NFeCancelamento2PRProd.xml",
...
public class NfeCancelamento2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NFeCancelamento2PRProd.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NFeCancelamento2PRProd.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
