...
package br.com.hs.nfe.ws.ce.homo.nfestatusservico2;
...
@WebServiceClient(name = "NfeStatusServico2", 
                  wsdlLocation = "file:NfeStatusServico2CEHomo.xml",
...
public class NfeStatusServico2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NfeStatusServico2CEHomo.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NfeStatusServico2CEHomo.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
