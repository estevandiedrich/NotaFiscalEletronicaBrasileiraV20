...
package br.com.hs.nfe.ws.ce.prod.nfeinutilizacao2;
...
@WebServiceClient(name = "NfeInutilizacao2", 
                  wsdlLocation = "file:NfeInutilizacao2CEProd.xml",
...
public class NfeInutilizacao2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NfeInutilizacao2CEProd.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NfeInutilizacao2CEProd.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
