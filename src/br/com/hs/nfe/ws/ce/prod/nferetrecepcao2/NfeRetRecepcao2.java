...
@WebServiceClient(name = "NfeRetRecepcao2", 
                  wsdlLocation = "file:NfeRetRecepcao2CEProd.xml",
...
public class NfeRetRecepcao2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NfeRetRecepcao2CEProd.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NfeRetRecepcao2CEProd.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
