...
package br.com.hs.nfe.ws.ce.prod.nferecepcao2;
...
@WebServiceClient(name = "NfeRecepcao2", 
                  wsdlLocation = "file:NfeRecepcao2CEProd.xml",
...
public class NfeRecepcao2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NfeRecepcao2CEProd.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NfeRecepcao2CEProd.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
