...
public final class RecepcaoEventoSoapPort_RecepcaoEvento_Client {
    ...
    public static void main(String args[]) throws Exception {
        ...
        RecepcaoEventoSoapPort port = ss.getRecepcaoEvento();  
