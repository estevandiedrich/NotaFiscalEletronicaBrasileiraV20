...
package br.com.hs.nfe.ws.rs.homo.nfeconsulta2;
...
public final class NfeConsulta2Helper {
    ...
    public String nfeConsulta2(String xml) throws Exception {
        ...
        factory.setAddress("https://homologacao.nfe.sefaz.rs.gov.br/ws/NfeConsulta/NfeConsulta2.asmx");
        ...
        _nfeConsultaNF2_nfeCabecMsgVal.setCUF("43");
