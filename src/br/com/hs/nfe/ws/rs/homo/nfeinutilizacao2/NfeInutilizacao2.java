...
@WebServiceClient(name = "NfeInutilizacao2", 
                  wsdlLocation = "file:nfeinutilizacao2.xml",
                  targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NfeInutilizacao2") 
public class NfeInutilizacao2 extends Service {

    public final static URL WSDL_LOCATION = Thread.currentThread().getContextClassLoader().getResource("wsdl/rs/homo/nfeinutilizacao2.wsdl");
