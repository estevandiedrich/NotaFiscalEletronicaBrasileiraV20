...
@WebServiceClient(name = "NfeRetRecepcao2", 
                  wsdlLocation = "file:NfeRetRecepcao2SVANHomo.xml",
...
public class NfeRetRecepcao2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NfeRetRecepcao2SVANHomo.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NfeRetRecepcao2SVANHomo.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
