...
@WebServiceClient(name = "NfeConsulta2", 
                  wsdlLocation = "file:NfeConsulta2SVANHomo.xml",
...
public class NfeConsulta2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NfeConsulta2SVANHomo.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NfeConsulta2SVANHomo.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
