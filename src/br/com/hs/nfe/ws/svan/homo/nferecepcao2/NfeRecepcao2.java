...
package br.com.hs.nfe.ws.svan.homo.nferecepcao2;
...
@WebServiceClient(name = "NfeRecepcao2", 
                  wsdlLocation = "file:NfeRecepcao2SVANHomo.xml",
...
public class NfeRecepcao2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NfeRecepcao2SVANHomo.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NfeRecepcao2SVANHomo.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
