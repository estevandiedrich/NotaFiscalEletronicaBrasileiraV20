...
public final class RecepcaoEventoSoap_RecepcaoEventoSoap_Client {
    ...
    public static void main(String args[]) throws Exception {
        ...
        RecepcaoEventoSoap port = ss.getRecepcaoEventoSoap();  
