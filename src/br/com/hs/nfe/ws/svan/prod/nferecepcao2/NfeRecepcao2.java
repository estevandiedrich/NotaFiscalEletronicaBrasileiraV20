...
package br.com.hs.nfe.ws.svan.prod.nferecepcao2;
...
@WebServiceClient(name = "NfeRecepcao2", 
                  wsdlLocation = "file:NfeRecepcao2SVANProd.xml",
...
public class NfeRecepcao2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:NfeRecepcao2SVANProd.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:NfeRecepcao2SVANProd.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
