...
@WebServiceClient(name = "NfeConsulta2", 
                  wsdlLocation = "file:NfeConsulta2.asmx.xml",
                  targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NfeConsulta2") 
public class NfeConsulta2 extends Service {

    public final static URL WSDL_LOCATION = Thread.currentThread().getContextClassLoader().getResource("wsdl/sc/homo/NfeConsulta2HomoSC.wsdl");
