...
package br.com.hs.nfe.ws.sc.homo.nfecancelamento2;
...
@WebServiceClient(name = "NfeCancelamento2", 
                  wsdlLocation = "file:NfeCancelamento2.asmx.xml",
                  targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NfeCancelamento2") 
public class NfeCancelamento2 extends Service {

    public final static URL WSDL_LOCATION = Thread.currentThread().getContextClassLoader().getResource("wsdl/sc/homo/NfeCancelamento2HomoSC.wsdl");
