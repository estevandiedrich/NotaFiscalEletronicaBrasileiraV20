...
public final class NfeStatusServico2Soap12_NfeStatusServico2_Client {
    ...
    private NfeStatusServico2Soap12_NfeStatusServico2_Client() {
    }
    ...
    public static void main(String args[]) throws Exception {
        ...
        NfeStatusServico2Soap12 port = ss.getNfeStatusServico2();  
