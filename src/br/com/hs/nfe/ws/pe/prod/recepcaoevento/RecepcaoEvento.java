...
@WebServiceClient(name = "RecepcaoEvento", 
                  wsdlLocation = "file:RecepcaoEventoPEProd.xml",
...
public class RecepcaoEvento extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:RecepcaoEventoPEProd.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:RecepcaoEventoPEProd.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
